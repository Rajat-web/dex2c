...
Java_piemods_Protect_initDcc__(JNIEnv *env, jobject thiz) {

}

JNIEXPORT void JNICALL
Java_piemods_Protect__0003cinit_0003e__(JNIEnv *env, jobject thiz) {
...
JNIEXPORT jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    jclass clz = env->FindClass("piemods/Protect");
